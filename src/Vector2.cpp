...
double Vector2::crossProduct(const Vector2 &v1, const Vector2 &v2) {
    // 2D cross product returns the z-component: x1*y2 - y1*x2
...
GlobalVector::GlobalVector() {
    startPoint = Vector2(0.0, 0.0);
    endPoint = Vector2(0.0, 0.0);
}

GlobalVector::GlobalVector(Vector2 startingPoint, Vector2 endPoint) {
